...
\begin{scope}[xshift=0cm]
  ...
  \node[draw=none,fill=none,font=\scriptsize,gray,text width=3.5cm,align=center]
    at (0,-2.3) {edges \& fills placed independently};
\end{scope}
%% ─── Divider ─────────────────────────────────────────────────────────────────
\draw[gray!35,thin] (2.4,1.9)--(2.4,-2.0);
%% ─── Right panel: Čech ───────────────────────────────────────────────────────
\begin{scope}[xshift=4.8cm]
  ...
  \begin{scope}[opacity=0.18]
    \fill[blue!50] (A2) circle (1.05);
    \fill[blue!50] (B2) circle (1.05);
    \fill[blue!50] (C2) circle (1.05);
  \end{scope}
  \draw[blue!55,dashed,thick] (A2) circle (1.05);
  \draw[blue!55,dashed,thick] (B2) circle (1.05);
  \draw[blue!55,dashed,thick] (C2) circle (1.05);
  ...
  \node[draw=none,fill=none,font=\scriptsize,gray,text width=3.5cm,align=center]
    at (0,-2.3) {fill determined by ball intersection};
\end{scope}
\end{tikzpicture}
...
\subsubsection*{Sharp threshold and simultaneous limits}
...
Bangachev and Bresler~\cite{BangachevBresler2024} showed that $\tau_\Delta$
...
test---would complete the computational picture.
...
formula. It would also be interesting to consider extensions to other latent geometries,
e.g.\ anisotropic~\cite{Brennan2022} or hyperbolic~\cite{Litvak2022}, where
triangle-based tests behave differently.
