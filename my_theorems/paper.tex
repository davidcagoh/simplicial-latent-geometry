...
\textbf{Lean status.} The key new integral $(112r^3/3)^d = E[F_t \cdot F_{t'}]$ for adjacent
$t,t'$ is currently being verified in Lean~4 (Aristotle job in progress). The combinatorial
