...
$\det G = 0$ (Wishart-derived; see scoping doc \texttt{paper2\_sphere\_scoping.md}
in the project repository). Headline:
\[
...
with structural axioms for the deep Wishart machinery (named: \texttt{capProb},
\texttt{normalQuantile}, \texttt{capCLT\_matched\_inversion},
\texttt{cechFillProb\_compl\_le\_gram\_tail}, \texttt{geomCovCech\_decomp\_ratio\_tendsto});
the asymptotic headlines are \emph{derived} from these.
